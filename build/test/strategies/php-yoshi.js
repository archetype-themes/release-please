...
(0, mocha_1.describe)('PHPYoshi', () => {
    ...
    (0, mocha_1.describe)('buildUpdates', () => {
        ...
        (0, mocha_1.it)('can override the version from BEGIN_VERSION_OVERRIDE body', async () => {
            const commit = (0, helpers_2.buildMockCommit)('chore: some commit');
            const body = 'BEGIN_VERSION_OVERRIDE\nClient1: 1.3.0\nClient2: 2.0.0-RC1\nEND_VERSION_OVERRIDE';
            commit.pullRequest = {
            ...
            commits.push(...(0, commit_1.parseConventionalCommits)([commit]));
            const strategy = new php_yoshi_1.PHPYoshi({
                targetBranch: 'main',
                github,
            });
            ...
            const updates = release.updates;
            const client1Version = (0, helpers_1.assertHasUpdate)(updates, 'Client1/VERSION');
            const client2Version = (0, helpers_1.assertHasUpdate)(updates, 'Client2/VERSION');
            (0, chai_1.expect)(client1Version.updater.updateContent('')).to.eql('1.3.0\n');
            (0, chai_1.expect)(client2Version.updater.updateContent('')).to.eql('2.0.0-RC1\n');
        });
    });
