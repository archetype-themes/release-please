...
(0, mocha_1.describe)('Strategy', () => {
    ...
    (0, mocha_1.describe)('buildReleasePullRequest', () => {
        ...
        (0, mocha_1.it)('updates extra JSON files with default', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            (0, helpers_1.assertHasUpdates)(updates, 'manifest.json', generic_json_1.GenericJson, generic_1.Generic);
        });
        (0, mocha_1.it)('updates extra YAML files with default', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            const updates = pullRequest === null || pullRequest === void 0 ? void 0 : pullRequest.updates;
            (0, chai_1.expect)(updates).to.be.an('array');
            (0, helpers_1.assertHasUpdates)(updates, 'pubspec.yaml', generic_yaml_1.GenericYaml, generic_1.Generic);
        });
        (0, mocha_1.it)('updates extra TOML files with default', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            const updates = pullRequest === null || pullRequest === void 0 ? void 0 : pullRequest.updates;
            (0, chai_1.expect)(updates).to.be.an('array');
            (0, helpers_1.assertHasUpdates)(updates, 'foo.toml', generic_toml_1.GenericToml, generic_1.Generic);
        });
        (0, mocha_1.it)('updates extra Xml files with default', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            const updates = pullRequest === null || pullRequest === void 0 ? void 0 : pullRequest.updates;
            (0, chai_1.expect)(updates).to.be.an('array');
            (0, helpers_1.assertHasUpdates)(updates, 'pom.xml', generic_xml_1.GenericXml, generic_1.Generic);
        });
        (0, mocha_1.it)('updates extra generic files', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            (0, helpers_1.assertHasUpdate)(updates, '1.yml', generic_1.Generic);
        });
